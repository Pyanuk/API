        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Admin>(entity =>
            {
                entity.HasKey(e => e.IdAdmin)
                    .HasName("PK__Admins__4C3F97F447098A7C");
            ...
            modelBuilder.Entity<AnalyseDocument>(entity =>
            {
                entity.HasKey(e => e.IdAppointment)
                    .HasName("PK__AnalyseD__ECE24AABC5CDAAA7");

                entity.ToTable("AnalyseDocument");

                entity.Property(e => e.IdAppointment).ValueGeneratedNever();

                entity.Property(e => e.NameAnalyseDocument).HasMaxLength(50);
            ...
            {
                entity.HasKey(e => e.IdAppointment)
                    .HasName("PK__Appointm__ECE24AAB7EFB3892");
            ...
            {
                entity.HasKey(e => e.IdAppointment)
                    .HasName("PK__Appointm__ECE24AAB345BD2C6");

                entity.ToTable("AppointmentDocument");

                entity.Property(e => e.IdAppointment).ValueGeneratedNever();

                entity.Property(e => e.NameAppointmentDocument).HasMaxLength(50);
            ...
            modelBuilder.Entity<Direction>(entity =>
            {
                entity.HasKey(e => e.IdDirection)
                    .HasName("PK__Directio__7780E2B2AF282A1C");
            ...
            modelBuilder.Entity<Doctor>(entity =>
            {
                entity.HasKey(e => e.IdDoctor)
                    .HasName("PK__Doctor__F838DB3E6D949364");
            ...
            modelBuilder.Entity<Patient>(entity =>
            {
                entity.HasKey(e => e.Oms)
                    .HasName("PK__Patient__CB396B8BB574C198");
            ...
            {
                entity.HasKey(e => e.IdAppointment)
                    .HasName("PK__Research__ECE24AAB58C30B78");

                entity.ToTable("ResearchDocument");

                entity.Property(e => e.IdAppointment).ValueGeneratedNever();

                entity.Property(e => e.NameResearchDocument).HasMaxLength(50);
            ...
            modelBuilder.Entity<Speciality>(entity =>
            {
                entity.HasKey(e => e.IdSpeciality)
                    .HasName("PK__Speciali__5C8D4E6869E0C17D");
            ...
            modelBuilder.Entity<Status>(entity =>
            {
                entity.HasKey(e => e.IdStatus)
                    .HasName("PK__Statuses__B450643AFE0EFB1D");
